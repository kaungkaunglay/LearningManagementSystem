...
<!-- Mirrored from lema.frontted.com/fluid-ui-pagination.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:59 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fluid layout-sticky-subnav">
  ...
  -->
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="fluid-ui-pagination.html">Pagination</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="ui-pagination.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-ui-pagination.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-ui-pagination.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
  ...
  -->
    ...
    <div id="app-settings">
      ...
      'default': 'ui-pagination.html',
      'fixed': 'fixed-ui-pagination.html',
      'fluid': 'fluid-ui-pagination.html',
      'mini': 'mini-ui-pagination.html'
    }"></app-settings>
    </div>
    <!-- jQuery -->
