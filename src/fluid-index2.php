...
<!-- Mirrored from lema.frontted.com/fluid-index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:46:00 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fluid layout-sticky-subnav">
                        ...
                        <ul class="nav navbar-nav">
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="fluid-index2.html" class="dropdown-item active">Home v2</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
  ...
  -->
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="home-v2.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-home-v2.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-home-v2.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="home-banner2 text-white mb-4">
                <div class="container-fluid page__container">
                    <h1 class="display-4 bold" data-aos="fade-up" data-aos-duration="800">Learn HTML with Video Courses</h1>
                    <p class="lead mb-5" data-aos="fade-up" data-aos-duration="1000">Get your first Job as a UI/UX Designer</p>
                    <div class="mb-4">
                        <div class="row">
                            <div class="col">
                                <div class="card card-body text-body">
                                    <h4 class="m-0"><strong class="text-primary">35</strong> Courses</h4>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card card-body text-body">
                                    <h4 class="m-0"><strong class="text-primary">405+</strong> Lessons</h4>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card card-body text-body">
                                    <h4 class="m-0"><strong class="text-primary">2395</strong> Students</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div data-aos="fade-down" data-aos-duration="400" data-aos-delay="400" data-offset="-100">
                        <a class="btn btn-success btn-lg px-4 py-2">Start Today <i class="material-icons">chevron_right</i> </a>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid page__container">
                ...
                <div class="m-4 p-4">
                    <h2 class="bold mb-1 text-center">Recent Courses</h2>
                    <p class="lead text-muted text-center">Our most recent releases</p>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card card__course card__course__animate">
                                <a href="fluid-student-course.html" class="card-img-top">
                                ...
                                <div class="p-3 text-center border-bottom">
                                    <div class="bold mb-2">
                                        <a href="fluid-student-course.html" class="text-body">
  ...
  <ul class="sidebar-menu mt-0 mb-4">
      ...
      <li class="sidebar-menu-item">
        <a class="sidebar-menu-button" href="fixed-home-v2.html">
      ...
      <li class="sidebar-menu-item">
        <a class="sidebar-menu-button" href="fluid-home-v2.html">
          <span class="sidebar-menu-icon sidebar-menu-icon--left">
  ...
  -->
    ...
    <div id="app-settings">
      ...
      'default': 'home-v2.html',
      'fixed': 'fixed-home-v2.html',
      'fluid': 'fluid-home-v2.html',
      'mini': 'mini-home-v2.html'
    }"></app-settings>
    </div>
    <!-- jQuery -->
