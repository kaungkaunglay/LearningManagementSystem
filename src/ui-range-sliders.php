...
<!-- Mirrored from lema.frontted.com/ui-range-sliders.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:58 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <ul class="nav navbar-nav d-none d-lg-flex pl-2">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item active" href="ui-range-sliders.html">Admin</a>
                                    <a class="dropdown-item" href="fluid-ui-range-sliders.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-ui-range-sliders.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
