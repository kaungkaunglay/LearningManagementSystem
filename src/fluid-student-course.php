...
<!-- Mirrored from lema.frontted.com/fluid-student-course.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:52 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fluid layout-sticky-subnav">
            ...
            <div class="page__header flush-shadow">
                <div class="container-fluid page__heading-container">
                    <div class="page__heading d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-lg-between text-center text-lg-left">
                        <div>
                            <h1 class="m-lg-0">Getting Started with this Course</h1>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="fluid-student-course.html">Course Lessons</a>
  ...
  -->
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="student-course.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-student-course.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-student-course.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
