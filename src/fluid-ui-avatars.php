...
<!-- Mirrored from lema.frontted.com/fluid-ui-avatars.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:57 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fluid layout-sticky-subnav">
  ...
  -->
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="fluid-ui-avatars.html">Avatars</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="ui-avatars.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-ui-avatars.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-ui-avatars.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="container-fluid page__container">
                ...
                <div class="card">
                    ...
                    <div class="card-body avatar-list">
                        ...
                        <div class="avatar avatar-xxl">
                            <span class="avatar-title rounded-circle bg-soft-primary text-primary">AD</span>
                        </div>
                        <div class="avatar avatar-xl">
                            <span class="avatar-title rounded-circle bg-soft-primary text-primary">AD</span>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body avatar-list">
                        ...
                        <div class="avatar-group">
                            ...
                            <div class="avatar avatar-lg">
                                <span class="avatar-title rounded-circle bg-success text-white">AD</span>
                            </div>
                        </div>
                        ...
                        <div class="avatar-group">
                            ...
                            <div class="avatar">
                                <span class="avatar-title rounded-circle bg-warning text-white">AD</span>
                            </div>
                        </div>
                        ...
                        <div class="avatar-group">
                            ...
                            <div class="avatar avatar-xs">
                                <span class="avatar-title rounded-circle bg-primary text-white">AD</span>
                            </div>
                        </div>
  ...
  -->
    ...
    <div id="app-settings">
      ...
      'default': 'ui-avatars.html',
      'fixed': 'fixed-ui-avatars.html',
      'fluid': 'fluid-ui-avatars.html',
      'mini': 'mini-ui-avatars.html'
    }"></app-settings>
    </div>
    <!-- jQuery -->
