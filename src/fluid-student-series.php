...
<!-- Mirrored from lema.frontted.com/fluid-student-series.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:52 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fluid layout-sticky-subnav">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="fluid-student-series.html">Series</a>
  ...
  -->
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="student-series.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-student-series.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-student-series.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="container-fluid page__container">
                ...
                <div class="card clear-shadow">
                    ...
                    <div class="bg-soft-light-gray card-header card-header-tabs-basic nav" role="tablist">
                        ...
                        <a href="#activity_purchases" data-toggle="tab" role="tab" aria-selected="false">Marketing</a>
                        <a href="#activity_emails" data-toggle="tab" role="tab" aria-selected="false">Back-End</a>
                        <a href="#activity_quotes" data-toggle="tab" role="tab" aria-selected="false">Design</a>
                    </div>
                </div>
  ...
  -->
    ...
    <div id="app-settings">
      ...
      'default': 'student-series.html',
      'fixed': 'fixed-student-series.html',
      'fluid': 'fluid-student-series.html',
      'mini': 'mini-student-series.html'
    }"></app-settings>
    </div>
    <!-- jQuery -->
