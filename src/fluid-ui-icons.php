...
<!-- Mirrored from lema.frontted.com/fluid-ui-icons.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:57 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fluid layout-sticky-subnav">
  ...
  -->
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="fluid-ui-icons.html">Icons</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="ui-icons.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-ui-icons.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-ui-icons.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
  ...
  -->
    ...
    <div id="app-settings">
      ...
      'default': 'ui-icons.html',
      'fixed': 'fixed-ui-icons.html',
      'fluid': 'fluid-ui-icons.html',
      'mini': 'mini-ui-icons.html'
    }"></app-settings>
    </div>
    <!-- jQuery -->
