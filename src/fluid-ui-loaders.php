...
<!-- Mirrored from lema.frontted.com/fluid-ui-loaders.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:59 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fluid layout-sticky-subnav">
  ...
  -->
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="fluid-ui-loaders.html">Loaders</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="ui-loaders.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-ui-loaders.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-ui-loaders.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
  ...
  -->
    ...
    <div id="app-settings">
      ...
      'default': 'ui-loaders.html',
      'fixed': 'fixed-ui-loaders.html',
      'fluid': 'fluid-ui-loaders.html',
      'mini': 'mini-ui-loaders.html'
    }"></app-settings>
    </div>
    <!-- jQuery -->
