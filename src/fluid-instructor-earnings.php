...
<!-- Mirrored from lema.frontted.com/fluid-instructor-earnings.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:56 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fluid layout-sticky-subnav">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="fluid-instructor-earnings.html">Earnings</a>
  ...
  -->
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="instructor-earnings.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-instructor-earnings.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-instructor-earnings.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
  ...
  -->
    ...
    <div id="app-settings">
      ...
      'fluid': 'fluid-instructor-earnings.html',
      'mini': 'mini-instructor-earnings.html'
    }"></app-settings>
    </div>
    <!-- jQuery -->
