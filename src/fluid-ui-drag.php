...
<!-- Mirrored from lema.frontted.com/fluid-ui-drag.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:59 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fluid layout-sticky-subnav">
  ...
  -->
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="fluid-ui-drag.html">Drag &amp; Drop</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="ui-drag.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-ui-drag.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-ui-drag.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row" data-toggle="dragula">
                            ...
                            <div class="col-md col-lg-4">
                                <div class="card form-row__card bg-warning">
                                    <div class="card-body">
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.
                                    </div> <!-- end card-body-->
                                </div> <!-- end card-->
  ...
  -->
    ...
    <div id="app-settings">
      ...
      'fluid': 'fluid-ui-drag.html',
      'mini': 'mini-ui-drag.html'
    }"></app-settings>
    </div>
    <!-- jQuery -->
