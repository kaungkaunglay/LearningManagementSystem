...
<!-- Mirrored from lema.frontted.com/fluid-instructor-payout.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:56 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fluid layout-sticky-subnav">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="fluid-instructor-payout.html">Payout</a> </div>
                            </li>
                            <!--
  <li class="nav-item dropdown">
  ...
  -->
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="instructor-payout.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-instructor-payout.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-instructor-payout.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
  ...
  -->
    ...
    <div id="app-settings">
      ...
      'default': 'instructor-payout.html',
      'fixed': 'fixed-instructor-payout.html',
      'fluid': 'fluid-instructor-payout.html',
      'mini': 'mini-instructor-payout.html'
    }"></app-settings>
    </div>
    <!-- jQuery -->
