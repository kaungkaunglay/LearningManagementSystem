...
<!-- Mirrored from lema.frontted.com/fluid-ui-charts.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:57 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fluid layout-sticky-subnav">
  ...
  -->
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="fluid-ui-charts.html">Charts</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="ui-charts.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-ui-charts.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-ui-charts.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="card-header card-header-large bg-white d-flex align-items-center">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="custom-control custom-checkbox-toggle ml-2">
                                <input checked="" aria-checked="true" type="checkbox" id="chart-switch-toggle" class="custom-control-input" role="switch" data-toggle="chart" data-target="#ordersChartSwitch" data-add='{"data":{"datasets":[{"data":[15,10,20,12,7,0,8,16,18,16,10,22],"backgroundColor":"#b2e599","label":"Affiliate","barPercentage":"0.5","barThickness":"20"}]}}'>
  ...
  -->
    ...
    <div id="app-settings">
      ...
      'fluid': 'fluid-ui-charts.html',
      'mini': 'mini-ui-charts.html'
    }"></app-settings>
    </div>
    <!-- jQuery -->
