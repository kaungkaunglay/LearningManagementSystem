...
<!-- Mirrored from lema.frontted.com/fluid-ui-vector-maps.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:46:00 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fluid layout-sticky-subnav">
  ...
  -->
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="fluid-ui-vector-maps.html">Vector Maps</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Layouts</a>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="ui-vector-maps.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-ui-vector-maps.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-ui-vector-maps.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
  ...
  -->
    ...
    <div id="app-settings">
      ...
      'default': 'ui-vector-maps.html',
      'fixed': 'fixed-ui-vector-maps.html',
      'fluid': 'fluid-ui-vector-maps.html',
      'mini': 'mini-ui-vector-maps.html'
    }"></app-settings>
    </div>
    <!-- jQuery -->
    ...
    <script src="assets/data/vector-maps/mall-map.js"></script>
    <script src="assets/data/vector-maps/gdp-data.js"></script>

    <script src="assets/js/vector-maps.js"></script>
    <script src="assets/js/page.ui-vector-maps.js"></script>
