...
<!-- Mirrored from lema.frontted.com/fluid-instructor-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:56 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Adrian Demian&#39;s Profile</title>
...
<body class="layout-fluid layout-sticky-subnav">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="fluid-instructor-profile.html">Profile</a>
  ...
  -->
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="instructor-profile.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-instructor-profile.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-instructor-profile.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
