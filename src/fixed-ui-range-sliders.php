...
<!-- Mirrored from lema.frontted.com/fixed-ui-range-sliders.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:23 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fixed layout-sticky-subnav">
  ...
  -->
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="fixed-ui-range-sliders.html">Range Sliders</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="ui-range-sliders.html">Admin</a>
                                    <a class="dropdown-item" href="fluid-ui-range-sliders.html">Full Width</a>
                                    <a class="dropdown-item active" href="fixed-ui-range-sliders.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="container page__container page__heading">
                <h1 class="mb-0">Range Sliders</h1>
                <p class="lead text-light-gray mb-0">Easy to use range sliders.</p>
            </div>


            <div class="container page__container">

                <p class=" p-0 mb-4">Easy to use, flexible and responsive range slider with skin support. Please read the <a target="_blank" href="http://ionden.com/a/plugins/ion.rangeSlider/index.html">official plugin documentation</a> for a full list of options.</p>
  ...
  -->
    ...
    <div id="app-settings">
      ...
      'default': 'ui-range-sliders.html',
      'fixed': 'fixed-ui-range-sliders.html',
      'fluid': 'fluid-ui-range-sliders.html',
      'mini': 'mini-ui-range-sliders.html'
    }"></app-settings>
    </div>
    <!-- jQuery -->
...
<!-- Mirrored from lema.frontted.com/fixed-ui-range-sliders.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:24 GMT -->
</html>