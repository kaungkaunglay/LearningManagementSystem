...
<!-- Mirrored from lema.frontted.com/fluid-instructor-course-edit.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:55 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fluid layout-sticky-subnav">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="fluid-instructor-course-edit.html">Edit Course</a>
  ...
  -->
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="instructor-course-edit.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-instructor-course-edit.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-instructor-course-edit.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
