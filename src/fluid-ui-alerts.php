...
<!-- Mirrored from lema.frontted.com/fluid-ui-alerts.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:57 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fluid layout-sticky-subnav">
                ...
                <div class="container-fluid page__container">
                    <div class="navbar navbar-secondary navbar-light navbar-expand-sm p-0 d-none d-md-flex" id="secondaryNavbar">
                        <ul class="nav navbar-nav">
                            <li class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Home Pages</a>
                                <div class="dropdown-menu">
                                    <a href="fluid-index.html" class="dropdown-item">Home v1</a>
                                    <a href="fluid-index2.html" class="dropdown-item">Home v2</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
  ...
  <li class="nav-item dropdown">
    ...
    <div class="dropdown-menu">
      <a class="dropdown-item" href="fluid-app-trello.html">Dashboard</a>
      <a class="dropdown-item" href="fluid-app-trello.html">Review Courses</a>
      <a class="dropdown-item" href="fluid-app-trello.html">Support Tickets</a>
      <a class="dropdown-item" href="fluid-app-trello.html">Reports</a>
      <a class="dropdown-item" href="fluid-app-trello.html">Website Settings</a> 
    </div>
  </li>
  -->
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="fluid-ui-alerts.html">Alerts</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="ui-alerts.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-ui-alerts.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-ui-alerts.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="row align-items-end">
                            <div class="col">
                                <div class="text-center p-3">
                                    ...
                                    <button type="button" class="btn btn-primary" data-toggle="toastr" data-toastr-type="primary" data-toastr-title="Heads up!" data-toastr-message="This alert needs your attention, but it is not super important.">
                                        Click me
                                    </button>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center p-3">
                                    ...
                                    <button type="button" class="btn btn-info" data-toggle="toastr" data-toastr-type="info" data-toastr-title="Heads up!" data-toastr-message="This alert needs your attention, but it is not super important.">
                                        Click me
                                    </button>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center p-3">
                                    ...
                                    <button type="button" class="btn btn-warning" data-toggle="toastr" data-toastr-type="warning" data-toastr-title="Heads up!" data-toastr-message="Check below fields please.">
                                        Click me
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="text-center p-3">
                                    ...
                                    <button type="button" class="btn btn-danger" data-toggle="toastr" data-toastr-type="error" data-toastr-title="Oh snap!" data-toastr-message="Change a few things up and try submitting again.">
                                        Click me
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-end">
                            <div class="col">
                                <div class="text-center p-3">
                                    ...
                                    <button type="button" class="btn btn-light" data-toggle="toastr" data-toastr-type="info" data-toastr-title="null" data-toastr-message="Set the closeButton to true and the toast will have a close button." data-toastr-time-out="0" data-toastr-extended-time-out="0" data-toastr-progress-bar="false" data-toastr-close-button="true">
                                        Click me
                                    </button>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center p-3">
                                    ...
                                    <button type="button" class="btn btn-light" data-toggle="toastr" data-toastr-type="info" data-toastr-title="Can I add <em>icons</em>?" data-toastr-message="Yes! check this <a href='https://github.com/'>update</a>.">
                                        Click me
                                    </button>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center p-3">
                                    ...
                                    <button type="button" class="btn btn-light" data-toggle="toastr" data-toastr-type="success" data-toastr-title="null" data-toastr-message="Set the timeOut and extendedTimeOut options to 0 and the toast will persist until selected." data-toastr-time-out="0" data-toastr-extended-time-out="0" data-toastr-progress-bar="false">
                                        Click me
                                    </button>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center p-3">
                                    ...
                                    <button type="button" class="btn btn-light" data-toggle="toastr" data-toastr-type="info" data-toastr-title="null" data-toastr-message="Use the jQuery show/hide method of your choice. These default to fadeIn/fadeOut. The methods fadeIn/fadeOut, slideDown/slideUp, and show/hide are built into jQuery." data-toastr-show-method="slideDown" data-toastr-hide-method="slideUp" data-toastr-close-method="slideUp">
                                        Click me
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="d-flex align-items-center sidebar-p-a border-bottom bg-light">
                        ...
                        <div class="dropdown ml-auto">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="fluid-student-dashboard.html">Dashboard</a>
                                <a class="dropdown-item" href="fluid-student-profile.html">My profile</a>
                                <a class="dropdown-item" href="fluid-student-edit-account.html">Edit account</a>
                                <div class="dropdown-divider"></div>
  ...
  -->
                    ...
                    <ul class="sidebar-menu mt-0">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fluid-student-series.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fluid-student-courses.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fluid-student-course.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fluid-student-take-course.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fluid-student-take-quiz.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fluid-student-billing.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fluid-student-profile.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fluid-login.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fluid-sign-up.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                    ...
                    <ul class="sidebar-menu mt-0">
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fluid-instructor-dashboard.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fluid-instructor-courses.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fluid-instructor-course-edit.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fluid-instructor-lesson-edit.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fluid-instructor-create-quiz.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fluid-instructor-earnings.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fluid-instructor-profile.html">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fluid-instructor-payout.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
  ...
  <ul class="sidebar-menu mt-0">
    ...
    <li class="sidebar-menu-item">
      <a class="sidebar-menu-button" href="fluid-series.html">
        <span class="sidebar-menu-icon sidebar-menu-icon--left">
    ...
    <li class="sidebar-menu-item">
      <a class="sidebar-menu-button" href="fluid-courses.html">
    ...
    <li class="sidebar-menu-item">
      <a class="sidebar-menu-button" href="fluid-course.html">
        <span class="sidebar-menu-icon sidebar-menu-icon--left">
    ...
    <li class="sidebar-menu-item">
      <a class="sidebar-menu-button" href="fluid-quizzes.html">
        <span class="sidebar-menu-icon sidebar-menu-icon--left">
  ...
  -->
    ...
    <div id="app-settings">
      ...
      'default': 'ui-alerts.html',
      'fixed': 'fixed-ui-alerts.html',
      'fluid': 'fluid-ui-alerts.html',
      'mini': 'mini-ui-alerts.html'
    }"></app-settings>
    </div>
    <!-- jQuery -->
