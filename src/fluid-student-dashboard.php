...
<!-- Mirrored from lema.frontted.com/fluid-student-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:50 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fluid layout-sticky-subnav">
            ...
            <div class="page__header flush-shadow">
                <div class="container-fluid page__heading-container">
                    <div class="page__heading d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-lg-between text-center text-lg-left">
                        ...
                        <div>
                            <a href="fluid-student-edit-account.html" class="btn btn-light ml-3"><i class="material-icons">edit</i> Edit</a>
                            <a href="fluid-student-profile.html" class="btn btn-success ml-1">View Profile <i class="material-icons">account_circle</i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="navbar navbar-secondary navbar-light navbar-expand-sm p-0 d-none d-md-flex" id="secondaryNavbar">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item active" href="fluid-student-dashboard.html">Dashboard</a>
  ...
  -->
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="student-dashboard.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-student-dashboard.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-student-dashboard.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                            ...
                            <ul class="list-group list-group-flush mb-0">
                                ...
                                <li class="list-group-item">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <a class="text-body mb-1" href="fluid-#"><strong>Level 1 HTML</strong></a><br>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="fluid-take-course.html" class="small">Basics of HTML</a>
                                            </div>
                                        </div>
                                ...
                                <li class="list-group-item">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <a class="text-body mb-1" href="fluid-#"><strong>Level 2 Angular</strong></a><br>
                                            <div class="d-flex align-items-center">
                                                <span class="text-blue mr-1">
                                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="16" height="16" style="position:relative; top:-2px">
                                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                                                ...
                                                <a href="fluid-take-course.html" class="small">Angular in Steps</a>
                                            </div>
                                        </div>
                                        <div class="media-right text-center d-flex align-items-center">
                                ...
                                <li class="list-group-item">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <a class="text-body mb-1" href="fluid-#"><strong>Graduation</strong></a><br>
                                            <div class="d-flex align-items-center">
                                                <span class="text-blue mr-1">
                                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="16" height="16" style="position:relative; top:-2px">
                                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                                                ...
                                                <a href="fluid-take-course.html" class="small">Bootstrap Foundations</a>
                                            </div>
                                        </div>
                                        <div class="media-right text-center d-flex align-items-center">
...
<!-- Mirrored from lema.frontted.com/fluid-student-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:51 GMT -->
</html>