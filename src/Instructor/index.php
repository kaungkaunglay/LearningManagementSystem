...
<!-- Mirrored from lema.frontted.com/instructor-dashboard.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:54 GMT -->
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-header card-header-large bg-light d-flex align-items-center">
                                        ...
                                        <h4 class="card-header__title">Created Quiz</h4>
                           ...
                           $raw =  CRUD::Select("Test",null, $condition);
                           foreach($raw as $data){
                            ?>
                                        <li class="list-group-item" style="z-index: initial;">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex">
                                                    <a href="#" class="text-body"><strong><?php echo $data['TestName'];  ?></strong></a>
                                                </div>
                                            </div>
                                        </li>
                            <?php  } ?>
...
<?php require_once "sidebar_menu.php" ?>
  ...
  -->
    ...
    <div id="app-settings">
      ...
      'default': 'instructor-dashboard.php',
      'fixed': 'fixed-instructor-dashboard.php',
      'fluid': 'fluid-instructor-dashboard.php',
      'mini': 'mini-instructor-dashboard.php'
    }"></app-settings>
    </div>
...
<!-- Mirrored from lema.frontted.com/instructor-dashboard.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:55 GMT -->
</html>