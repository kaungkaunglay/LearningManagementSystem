            ...
            <div class="mdk-drawer-layout__content page">
                ...
                <div class="container-fluid page__heading-container">
                    <div class="page__heading d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-lg-between text-center text-lg-left">
                        <h1 class="m-lg-0">Instructor Course</h1>
                        <a href="instructor-course-edit.php" class="btn btn-success ml-lg-3">New Test <i class="material-icons">add</i></a>
                    </div>
                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row">
                                            ...
                                            <div class="flex" style="min-width: 200px;">
                                                <div class="d-flex">
                                                    <div>
                                                        <h4 class="card-title mb-1"><a href="instructor-quiz-edit.php?tid=<?php echo $item['CourseID'] ?>"><?php echo $item['CourseName'] ?></a></h4>
                                                        <p class="text-muted"><?php echo $item['CourseDescription']; ?></p>
                                                    </div>
                                                    <div class="dropdown ml-auto">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="instructor-course-edit.php?cid=<?php echo $item['CourseID'] ?>">Edit Course</a>
                                                            <a class="dropdown-item" href="CourseRedirect.php?cid=<?php echo $item['CourseID'] ?>">Create Lessons</a>
                                                            <a class="dropdown-item" href="PreviewRedirect.php?cid=<?php echo $item['CourseID'] ?>">Preview</a>
                                                            <div class="dropdown-divider"></div>
                                                            <a class="dropdown-item text-danger" href="delete.php?cid=<?php echo $item['CourseID'] ?>">Delete</a>
                                                        </div>
                                                    </div>
                                                </div>
