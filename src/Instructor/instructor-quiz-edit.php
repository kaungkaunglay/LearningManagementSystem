...
if(isset($_GET['tid'])){
    ...
    $raw = CRUD::Select("Test",array("TestName","TestDescription"),$condition12);
    $Test_name = $raw[0]['TestName'];
    $description = $raw[0]['TestDescription'];
}
if(isset($_POST['submit'])){
    if(isset($_GET['tid'])){
        ...
        $check = CRUD::Update("Test", $columns,$condition);
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__container">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card">
                                    <form class="card-form__body card-body" action="instructor-course-edit.php<?php if(isset($_GET['tid'])) {echo '?tid='.$_GET['tid']; } ?>" method="post">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card">
                                    <div class="card-header card-header-large bg-light d-flex align-items-center">
                                        <div class="flex">
                                            <h4 class="card-header__title">Quiz</h4>
                                            <div class="card-subtitle text-muted">Manage Quiz</div>
                                        </div>
                                        <div class="ml-auto">
                                            <a href="instructor-create-quiz.php?tid=<?php echo $_GET['tid'] ?>" class="btn btn-primary">New <i class="material-icons">add</i></a>
                                        </div>
                                    </div>
                                <?php
                                $cols_arr = array("QuestionName");
                                $condition = [
                                    "TestID" => $_GET['tid']
                                ];
                                $rows = CRUD::Select("Question",$cols_arr,$condition);
                                    ...
                                    <ul class="list-group list-group-fit">
                                        <li class="list-group-item">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <a href="instructor-create-quiz.php?tid=<?php  echo $_GET['tid'] ?>"><?php echo $items['QuestionName'] ?></a>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
