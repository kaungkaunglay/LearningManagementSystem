...
if(isset($_SESSION['TeacherID'])){
    $colum = array("TeacherName");
    $condition = [
            "TeacherID" => $_SESSION['TeacherID']
    ];
    $raw = CRUD::Select("Teacher",$colum,$condition);
    $name = $raw[0]['TeacherName'];
}else{
    ...
    <div class="navbar navbar-expand-sm navbar-main navbar-dark bg-primary pl-md-0 pr-0" id="navbar" data-primary>
        <div class="container-fluid pr-0 ">
            ...
            <div class="d-flex sidebar-account flex-shrink-0 mr-auto mr-lg-0">
                <a href="index.php" class="flex d-flex align-items-center text-underline-0">
                    ...
                    <span class="flex d-flex flex-column text-white">
                                    <strong class="sidebar-brand">Learning Management System</strong>
                                </span>
                </a>
            </div>
            ...
            <ul class="nav navbar-nav d-none d-lg-flex pl-2">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item active" href="index.php"><?php
                            if(!is_null($name)){
                                echo $name;
                            }
                            ?></a>
            ...
            <form class="search-form search-form--light d-none d-sm-flex flex ml-3" action="https://lema.frontted.com/index.php">
                ...
                <div id="company_menu" class="dropdown-menu dropdown-menu-right navbar-company-menu">
                    <div class="dropdown-item d-flex align-items-center py-2 navbar-company-info py-3">
                        ...
                        <span class="flex d-flex flex-column">
                                        <strong class="h5 m-0"><?php echo $name; ?></strong>
                                        <small class="text-muted text-uppercase">Instructor</small>
                                    </span>

                    </div>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item d-flex align-items-center py-2" href="instructor-profile.php">
                        <span class="material-icons mr-2">account_circle</span> View Account
                    </a>
                    <a class="dropdown-item d-flex align-items-center py-2" href="instructor-edit-profile.php">
                        <span class="material-icons mr-2">settings</span> Edit account
                    </a>
                    <a class="dropdown-item d-flex align-items-center py-2" href="instructor_logout.php">
