...
<!-- Mirrored from lema.frontted.com/fluid-student-courses.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:52 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fluid layout-sticky-subnav">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="fluid-student-courses.html">Courses</a>
  ...
  -->
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="student-courses.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-student-courses.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-student-courses.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card card__course">
                            <div class="card-header card-header-large card-header-dark bg-dark d-flex justify-content-center">
                                <a class="card-header__title  justify-content-center align-self-center d-flex flex-column" href="fluid-student-course.html">
