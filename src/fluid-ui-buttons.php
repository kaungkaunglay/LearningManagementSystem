...
<!-- Mirrored from lema.frontted.com/fluid-ui-buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:56 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fluid layout-sticky-subnav">
  ...
  -->
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item active" href="fluid-ui-buttons.html">Buttons</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="ui-buttons.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-ui-buttons.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-ui-buttons.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
  ...
  -->
    ...
    <div id="app-settings">
      ...
      'fluid': 'fluid-ui-buttons.html',
      'mini': 'mini-ui-buttons.html'
    }"></app-settings>
    </div>
    <!-- jQuery -->
