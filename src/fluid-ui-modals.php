...
<!-- Mirrored from lema.frontted.com/fluid-ui-modals.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:57 GMT -->
<head>
    <meta charset="utf-8">
  ...
  -->
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="fluid-ui-modals.html">Modals</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="ui-modals.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-ui-modals.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-ui-modals.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="modal-body">
                    <div class="px-3">
                        <div class="d-flex justify-content-center mt-2 mb-4 navbar-light">
                            <a href="fluid-index.html" class="navbar-brand" style="min-width: 0">
                                <!-- LOGO -->
