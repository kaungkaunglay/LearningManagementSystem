...
if(isset($_SESSION['StudentID'])){
    $cols_array = array("StudentName","StudentEmail","Description","StudentPassword");
    $condition  = [
        "StudentID" => $_SESSION['StudentID']
    ];
    $data =  CRUD::Select("Student",$cols_array,$condition);
    $student_name = $data[0]['StudentName'];
    $student_description = $data[0]['Description'];
    $student_email = $data[0]['StudentEmail'];
    $student_password = $data[0]['StudentPassword'];
    // Get Quiz Taken
    $cols_array = array("TestID");
    $data = CRUD::Select("QuestionAnswer",$cols_array,$condition);
    $quiz_taken = count($data);
}
?>
        ...
        <div class="d-flex sidebar-account flex-shrink-0 mr-auto mr-lg-0">
            <a href="index.html" class="flex d-flex align-items-center text-underline-0">
                ...
                <span class="flex d-flex flex-column text-white">
                                    <strong class="sidebar-brand">Learning Mangement System</strong>
                                </span>
            </a>
        </div>
        ...
        <div class="dropdown">
            <a href="#account_menu" class="dropdown-toggle navbar-toggler navbar-toggler-dashboard border-left d-flex align-items-center ml-navbar" data-toggle="dropdown">
                ...
                <span class="ml-1 d-flex-inline">
                                    <span class="text-light"><?php echo $student_name; ?></span>
                                </span>
            </a>
            <div id="company_menu" class="dropdown-menu dropdown-menu-right navbar-company-menu">
                <div class="dropdown-item d-flex align-items-center py-2 navbar-company-info py-3">
                    ...
                    <span class="flex d-flex flex-column">
                                        <strong class="h5 m-0"><?php echo $student_name; ?></strong>
                                        <small class="text-muted text-uppercase">STUDENT</small>
                                    </span>
                </div>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item d-flex align-items-center py-2" href="student-edit-account.php">
                ...
                <a class="dropdown-item d-flex align-items-center py-2" href="student-profile.php">
                    <span class="material-icons mr-2">account_circle</span> View my account
                </a>
