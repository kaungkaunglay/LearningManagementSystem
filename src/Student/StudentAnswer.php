            ...
            <div class="mdk-drawer-layout__content page">
                ...
                <div class="container-fluid page__heading-container">
                    <div class="page__heading d-flex align-items-center justify-content-between">
                        <h1 class="m-0">Answered Tests </h1>
                ...
                <div class="container-fluid page__container">
                    ...
                    <div class="row">
                        <?php
                            $cols = array("QuestionID", "QuestionChoiceID", "TestID");
                            $condition = [
                                    "StudentID" => $_SESSION['StudentID']
                            ];
                            $group_column = array("TestID");
                            $row = CRUD::Select("QuestionAnswer", $cols, $condition,null,null,true,$group_column);
                            if(!empty($row)){
                            foreach($row as $value){
                                //Get Test
                                $column_array = array("TestName", "TestDescription", "TeacherID");
                                $second_condition =[
                                        "TestID" => $value['TestID']
                                ];
                               $result =  CRUD::Select("Test",$column_array, $second_condition);
                               //Get Student
                                $column_array_student = array("TeacherName");
                                $third_condition  =[
                                        "TeacherID" => $result[0]['TeacherID']
                                ];
                                $data = CRUD::Select("Teacher", $column_array_student, $third_condition);
                            ?>
                            <div class="col-md-3">
                                <div class="card card__course">
                                    <div class="card-header card-header-large card-header-dark bg-dark d-flex justify-content-center">
                                        <a class="card-header__title  justify-content-center align-self-center d-flex flex-column" href="student-course.html">
                                            ...
                                            <span class="course__title"><?php echo $result[0]['TestName'];  ?></span>
                                            <span class="course__subtitle"><?php echo $result[0]['TestDescription']; ?></span>
                                        </a>
                                    </div>
                                    <div class="p-3">
                                        <div class="mb-2">
                                            <?php echo "Tested by : ". $data[0]['TeacherName'];  ?>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <a href="RedirectAnswer.php?testid=<?php echo $value['TestID']; ?>" class="btn btn-primary ml-auto">View</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        <?php  } }else{?>
                        <div>You have not answered any of the test yet ! </div>
                        <?php } ?>
                    </div>
                    <hr>
