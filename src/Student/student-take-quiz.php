                        ...
                        <ul class="nav navbar-nav d-none d-lg-flex pl-2">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item active" href="student-take-quiz.html">Admin</a>
            ...
            <div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px">
                <div class="mdk-drawer-layout__content page">
                    ...
                    function Answer($choice){
                        ...
                        // Check to update
                        $cols = array("QuestionID");
                        $condition = [
                                "QuestionID" => $_SESSION['QuestionID']
                        ];
                        $result = CRUD::Select("QuestionAnswer",$cols, $condition);
                        if(empty($result)){
                            $insert_columns =[
                                ...
                                "TestID" => $_GET['testid'],
                                "is_right"  => Check_Answer_is_Correct($choice,$_SESSION['QuestionID'])
                            ];
                            CRUD::Insert("QuestionAnswer",$insert_columns);
                        }else{
                            $update_columns = [
                                    "QuestionChoiceID" => $choice,
                                    "is_right" => Check_Answer_is_Correct($choice, $_SESSION['QuestionID'])
                            ...
                            CRUD::Update("QuestionAnswer",$update_columns,$update_condition);
                        }
                    }
                    if(isset($_POST['next'])){
                        Answer($_POST['choice']);
                    ...
                    if(isset($_POST['submit'])){
                        Answer($_POST['choice']);
                        $test_id = $_GET['testid'];
                        echo "<script>window.location='RedirectAnswer.php?testid=$test_id'</script>";
                    }
                    ...
                    <div class="container-fluid page__container">
                        <div class="row">
                            <form class="col-md-8" method="post" action="student-take-quiz.php?testid=<?php echo $_GET['testid'] ?>">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        function Check_Answered($questionsID, $Qtchoice){
                                            $answered_column = array("QuestionChoiceID");
                                            $answered_condition = [
                                                "QuestionID" => $questionsID[$_SESSION['count']]
                                            ];
                                            $result = CRUD::Select("QuestionChoice",$answered_column,$answered_condition);
                                            if($result[0]["QuestionChoiceID"] == $Qtchoice){
                                                echo "Checked";
                                            }
                                        }
                                        ...
                                        <li class="list-group-item d-flex" data-position="2" data-answer-id="5" data-question-id="2">
                                            ...
                                            <div class="ml-auto">
                                                <input required type="radio" name="choice" id="<?php echo $value['QuestionChoiceID'] ?>" value="<?php echo $value['QuestionChoiceID'] ?>">
                                            </div>
                                        </li>
                                    <?php  } ?>
                                    </div>
                                    <div class="card-footer">
                                        ...
                                        <input name="submit" type="submit" class="btn btn-success float-right" value="Submit">
                                        <?php }?>
