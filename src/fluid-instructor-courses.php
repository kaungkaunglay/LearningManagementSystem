...
<!-- Mirrored from lema.frontted.com/fluid-instructor-courses.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:55 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fluid layout-sticky-subnav">
            ...
            <div class="page__header flush-shadow">
                <div class="container-fluid page__heading-container">
                    <div class="page__heading d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-lg-between text-center text-lg-left">
                        ...
                        <a href="fluid-instructor-course-edit.html" class="btn btn-success ml-lg-3">New Course <i class="material-icons">add</i></a>
                    </div>
                </div>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="fluid-instructor-courses.html">My Courses</a>
  ...
  -->
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="instructor-courses.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-instructor-courses.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-instructor-courses.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-column flex-sm-row">
                                    ...
                                    <div class="flex" style="min-width: 200px;">
                                        <div class="d-flex">
                                            <div>
                                                <h4 class="card-title mb-1"><a href="fluid-instructor-course-edit.html">Learn Vue.js</a></h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-column flex-sm-row">
                                    ...
                                    <div class="flex" style="min-width: 200px;">
                                        <div class="d-flex">
                                            <div>
                                                <h4 class="card-title mb-1"><a href="fluid-instructor-course-edit.html">Npm &amp; Gulp Advanced Workflow</a></h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-column flex-sm-row">
                                    ...
                                    <div class="flex" style="min-width: 200px;">
                                        <div class="d-flex">
                                            <div>
                                                <h4 class="card-title mb-1"><a href="fluid-instructor-course-edit.html">Gitlab for Beginners</a></h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-column flex-sm-row">
                                    ...
                                    <div class="flex" style="min-width: 200px;">
                                        <div class="d-flex">
                                            <div>
                                                <h4 class="card-title mb-1"><a href="fluid-instructor-course-edit.html">Ruby on Rails Workflows</a></h4>
                                                <p class="text-muted">Let’s start with a quick tour of Vue’s data binding features.</p>
                                            </div>
                                            <div class="dropdown ml-auto">
                                                <a href="#" class="dropdown-toggle text-muted" data-caret="false" data-toggle="dropdown">
