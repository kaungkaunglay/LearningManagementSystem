...
<!-- Mirrored from lema.frontted.com/fluid-ui-datetime.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 02:45:58 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="layout-fluid layout-sticky-subnav">
  ...
  -->
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="fluid-ui-datetime.html">Time &amp; Date</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="ui-datetime.html">Admin</a>
                                    <a class="dropdown-item active" href="fluid-ui-datetime.html">Full Width</a>
                                    <a class="dropdown-item" href="fixed-ui-datetime.html">Fixed</a>
                                </div>
                            </li>
                        </ul>
                    </div>
  ...
  -->
    ...
    <div id="app-settings">
      ...
      'default': 'ui-datetime.html',
      'fixed': 'fixed-ui-datetime.html',
      'fluid': 'fluid-ui-datetime.html',
      'mini': 'mini-ui-datetime.html'
    }"></app-settings>
    </div>
    <!-- jQuery -->
